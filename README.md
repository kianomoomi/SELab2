...
## گام ۳
تغییرات ذکر شده در قسمت قبل را روی کد انجام دادیم و آن را در پوشه‌ی مربوطه قرار دادیم. توضیح خاص دیگری وجود ندارد. در نهایت interface مربوطه را به دو interface جدا شکاندیم که هر کدام یک تابع درون خود دارند و حالت‌های مختلف پرداخت و رجیستر هر کدام را به سلیقه‌ی خود implement می‌کنند.
## گام ۴
### سوال ۱:  
...
## گام ۵  
استفاده از اصول SOLID کیفیت کد را بالا می‌برد و سیستم را maintainable‌تر می‌کند. همان‌طور که می‌دانیم یک برنامه زمانی می‌میرد که دیگر maintainable نباشد. استفاده از این اصول امکان ایجاد تغییر و اضافه کردن ویژگی‌های جدید به برنامه را به طور قابل توجهی آسان‌تر می‌سازد. این اصول کد را تمیز‌تر، استاندارد‌تر، قابل فهم‌تر و معمولا کوتاه‌تر می‌کند. این اصول یکی از فاکتور‌هایی است که یک مهندس نرم‌افزار را از یک دولوپر ساده متمایز می‌سازد. در حالت ابتدایی برای تغییرات و develop کردن فیچر‌ها نیاز به shotgun surgery داشتیم و جاهای زیادی باید دست می‌خورد و به نوعی کد ما قابل توسعه به راحتی نبود. اما اگر این اصول SOLID را به کار گیریم، همانطور که دیدید نتیجه بسیار کد بهتر و خواناتر و قابلیت maintain کردن راحت‌تر شد.
